...
const filteredVideos = computed(() => {
  ...
  return videos.value.filter((video: any) => video.category === selectedCategory.value);
});
...
<template>
  <div class="container">
    ...
    <nav class="categories-nav">
      ...
      <!-- <NuxtLink to="/admin" class="category-chip admin-link">
        Admin
      </NuxtLink> -->
    </nav>
      ...
      <article v-for="video in filteredVideos" :key="video.id" class="video-card">
        <div class="card-content">
          <div class="tags">
            ...
            <span v-if="video.subcategory" class="category-tag subcategory-tag">{{ video.subcategory }}</span>
          </div>
